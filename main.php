...
<table border=1 cellspacing=0 cellpadding=0 bgcolor="<? echo $color_header; ?>" width="75%" align=center>
 <tr>
...
<TABLE BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR="<? echo $color_header; ?>" align="center">
<TR><TD NOWRAP>
<div class=mnu>
...
&nbsp;<a class=mnu href="feedback.php"><? echo $l_feedback ; if($playerinfo[pay] == 'Y') echo " (VIP)"; ?></a>&nbsp;<br>
<?
...
$resA = $db->Execute("SELECT character_name, UNIX_TIMESTAMP(last_login) as online FROM $dbtables[ships] WHERE team = $playerinfo[team] AND ship_id != $playerinfo[ship_id] ORDER BY character_name"); 
if(!$resA)
	{
	echo " !! ERROR !! ";
	}
	...
	while(!$resA->EOF)
		...
		$difftime = (TIME() - $rowA[online]) / 60;

		if($difftime <= 5) echo "<FONT COLOR=#55BB55>";
		echo "&nbsp;" . $rowA['character_name'] . "&nbsp;<BR>";
		if($difftime <= 5) echo "</FONT>";
...
<table BORDER=1 CELLPADDING=0 CELLSPACING=0 BGCOLOR="<? echo $color_header; ?>" align="center"> 
<tr><td>
<table BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="<? echo $color_header; ?>" align="center" class=dis> 
...
<STYLE>.rsform { font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 7.5pt; font-weight: bold; color: #FFFFFF; background-color:<? echo $color_header; ?>;}</STYLE>
<TABLE BORDER=1 CELLPADDING=1 CELLSPACING=0 BGCOLOR="<? echo $color_header; ?>" align="center">
<TR align="center"><TD NOWRAP>
<div class=mnu>

<?

if (($playerinfo[sector] -1) >= 0)
echo "&nbsp;<a class=mnu href='rsmove.php?engage=1&destination=" . ($playerinfo[sector] -1) . "'>" . ($playerinfo[sector] -1) . "&nbsp;&lt;=</a>";

if (($playerinfo[sector] +1) <= $sector_max)
echo "&nbsp;<a class=mnu href='rsmove.php?engage=1&destination=" . ($playerinfo[sector] +1) . "'>=&gt;&nbsp;" . ($playerinfo[sector] +1) . "</a>";

?>


</div></td></tr><tr><form method="post" action="rsmove.php" name="rsmove"><td nowrap=""><div class=mnu>
...
&nbsp;=&gt;&nbsp;
<input type="text" name="destination" class="rsform" maxlength="10" size="3">
<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" name="explore" value="&nbsp;?&nbsp;" class="rsform">&nbsp;
<input type="submit" name="go" value="Go" class="rsform" onClick="rsmove.engage.value=1;">
<input type="hidden" name="engage" value="0">
</div>
</td></form></tr>
</table>
